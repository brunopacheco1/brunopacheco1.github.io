...
Well, let’s begin. I personally started learning Quenya around 2004, if I remember correctly, through the translation made by [Gabriel Brum](https://www.linkedin.com/in/gabriel-oliva-brum/) of the Quenya course created by [Helge Fauskanger](https://ardalambion.net/whoami.htm). There was no other material available in Portuguese at the time, and I had to make do. Today, experience, knowledge of other languages, internet access, and my geographical location lead me to higher levels, and that is why I want to share a bit with anyone who might be interested in the subject.
...
* [Plural](https://eldamo.org/content/words/word-2870822299.html).
* [Objects and things in pairs](https://eldamo.org/content/words/word-1147827707.html). 
...
* [Ambar Eldaron](https://www.ambar-eldaron.com/publications.html): A French group offering a Quenya course, as well as verb tables and a book on Elvish botany.
* [Mellonath Daeron](https://forodrim.org/daeron/publications.html): The linguistic arm of the Tolkien Society of Sweden (Forodrim), featuring various articles.
* [Boktypografen](https://at.boktypografen.se/index.html): This page is dedicated to the writing systems derived from Tolkien's works, created by Måns Björkman Berg, a member of the Swedish Tolkien Society.
* [Alcarin Tengwar](https://tosche.net/fonts/alcarin-tengwar): An open-source Tengwar font.
* [Free Tengwar Font Project](https://freetengwar.sourceforge.net/): An open-source project providing various Tengwar fonts to the community.
* [Tengwar Ariador](https://github.com/Ariador/tengwar-ariador): Another repository for the open-access font.
* [Elfdict](https://www.elfdict.com/): One of the online dictionaries for quick searches of Quenya terms.
* [QuenyaTTS](https://annie-zhou1997.github.io/QuenyaTTS.github.io/): A text-to-speech synthesizer focused on Quenya pronunciation.
* [Vinye Lambegormon](https://discord.gg/2d49Bnbs): A Discord server focused on learning and practicing Elvish languages.
...
* [Quettar](https://www.quettar.org/): Founded by Susan Rule, it was the bulletin of the Linguistic Fellowship of the Tolkien Society (UK).
* [The Elvish Linguistic Fellowship (E.L.F.)](https://www.elvish.org/): The E.L.F. is a North American organization dedicated to the scholarly study of J.R.R. Tolkien’s invented languages. Its primary work is published through its two print journals, *Vinyar Tengwar* and *Parma Eldalamberon*, as well as its online journal, *Tengwestië*.

**Namárië | See you | Bis geschwënn | Até mais | À bientôt**
